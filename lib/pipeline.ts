...
export const PIPELINE_ID = 'invoice-reconcile-v1'
export const STEP_ORDER: StepId[] = ['input', 'process', 'output']
export const STEP_LABELS: Record<StepId, string> = {
  input: "Step 1/3 · Capture inputs for ReconcileIO",
  process: "Step 2/3 · Apply rules & draft with ReconcileIO",
  output: "Step 3/3 · Deliver ReconcileIO result",
}
