      ...
      <div className="min-h-screen bg-slate-50 text-slate-800">
        ...
        <main className="max-w-3xl mx-auto px-6 py-14">
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-6">
            ...
            <p className="mt-2 text-sm text-slate-600"><span className="font-medium">How Invoice Reconcile helps:</span> Invoice Reconcile turns raw input into a reviewed, exportable result in minutes.</p>
          </div>
          <div className="rounded-xl border border-slate-200 bg-white p-6">
            ...
            <p className="mt-2 text-sm text-slate-600"><span className="font-medium">How Invoice Reconcile helps:</span> Self-serve: paste input, get a structured deliverable and share it.</p>
          </div>
          <div className="rounded-xl border border-slate-200 bg-white p-6">
            ...
            <p className="mt-2 text-sm text-slate-600"><span className="font-medium">How Invoice Reconcile helps:</span> Invoice Reconcile is the drop-in layer they can white-label or embed.</p>
          </div>
          </div>
        </main>
