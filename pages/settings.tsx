      ...
      <main className="min-h-screen bg-slate-50 text-slate-900">
        <div className="max-w-xl mx-auto px-6 py-16">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-6">
            <h2 className="text-lg font-bold mb-2">Run history &amp; export</h2>
            <p className="text-sm text-slate-600 mb-4">
              Download your past {PRODUCT.name} workflow runs as JSON. Runs are stored server-side (not in the browser).
            </p>
            <a href={`/api/runs?format=json`} className="inline-block px-4 py-2 rounded-full bg-indigo-600 text-white font-semibold text-sm">
              Export runs (JSON)
            </a>
          </div>
