...
> Match payments to invoices in one paste
>
> Paste your invoice list and your payment / Stripe export; get a matched table showing what is paid, partial, or missing. For founders who close the books every month.
...
```bash
npm run build
# Vercel: import repo, set framework = Next.js, root = 12_Micro_SaaS出海/invoice-reconcile
```
